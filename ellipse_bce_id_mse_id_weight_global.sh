...
python train.py --dataroot $DATAROOT --name ellipse_bce_id_mse_id_weighted_global \
	...
	--with_BCE  \
	--g_lr 0.0002 --d_lr 0.002 \
	--lambda_A 1 --lambda_A2 0.001 --lambda_B 1 --lambda_B2 1000 --lambda_D 1 \
