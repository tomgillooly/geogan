...
python train.py --dataroot $DATAROOT --name geo_pix2pix_wgan_three_critic --model pix2pix_geo --which_model_netG unet_256 --which_direction BtoA --continue_train --epoch_count 95 --num_discrims 3 \
