...
python train.py --dataroot $DATAROOT --name geo_pix2pix_wgan_local_only --model pix2pix_geo --which_model_netG unet_256 --which_direction BtoA --input_nc 3 --output_nc 3 --lambda_A 100 --lambda_B 100 --dataset_mode geo --no_lsgan --norm batch --pool_size 0 --no_html --div_threshold 1000 $OPTIONS --batchSize 4
