...
python train.py --dataroot $DATAROOT --name geo_voronoi_self_attn_transfer --x_size 512 \
        --model div_inline --which_direction BtoA \
	--continue_train --which_epoch 95 --epoch_count 96 \
	...
	--display_freq 500 --print_freq 500 --save_epoch_freq 100 \
