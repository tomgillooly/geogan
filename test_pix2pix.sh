...
python test.py --dataroot $DATAROOT --name geo_pix2pix_wgan_base --model pix2pix_geo --which_model_netG unet_256 \
	--which_epoch $1  --how_many 50 --visualise_hausdorff --visualise_ot \
