...
python train.py --dataroot $DATAROOT --name ellipse_log_global_self_attn_param_set2_no_restart \
	...
	--lambda_A 54.6 --lambda_A2 75.5 --lambda_B 31.5 --lambda_B2 130.1 --lambda_D 1 \
